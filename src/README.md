...
- **Design tokens**: `index.css`, blok `@theme` (Tailwind v4, CSS-first). Base gelap `#161512`, accent
  `#8fbf67` (turunan lebih cerah dari hijau board `#769656` — papan sendiri TIDAK ikut berubah warna).
  Font: Manrope (UI) + IBM Plex Mono (nanti buat notasi SAN/clock, load dari Google Fonts di `index.html`).
